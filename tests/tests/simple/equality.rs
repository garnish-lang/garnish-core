...
mod lists {
    ...
    fn equality_only_items_equal() {
        ...
        list_index1 = runtime.get_data_mut().add_to_list(list_index1, i1).unwrap();
        list_index1 = runtime.get_data_mut().add_to_list(list_index1, i2).unwrap();
        list_index1 = runtime.get_data_mut().add_to_list(list_index1, i3).unwrap();
        let i4 = runtime.get_data_mut().end_list(list_index1).unwrap();

        let i5 = runtime.get_data_mut().add_number(10.into()).unwrap();
        let i6 = runtime.get_data_mut().add_number(10.into()).unwrap();
        let i7 = runtime.get_data_mut().add_number(10.into()).unwrap();
        let mut list_index2 = runtime.get_data_mut().start_list(3).unwrap();
        list_index2 = runtime.get_data_mut().add_to_list(list_index2, i5).unwrap();
        list_index2 = runtime.get_data_mut().add_to_list(list_index2, i6).unwrap();
        list_index2 = runtime.get_data_mut().add_to_list(list_index2, i7).unwrap();
        let i8 = runtime.get_data_mut().end_list(list_index2).unwrap();
    ...
    fn equality_only_items_not_equal() {
        ...
        list_index2 = runtime.get_data_mut().add_to_list(list_index2, i6).unwrap();
        list_index2 = runtime.get_data_mut().add_to_list(list_index2, i7).unwrap();
        let list_index2 = runtime.get_data_mut().end_list(list_index2).unwrap();
    ...
    fn equality_associations_not_equal() {
        ...
        let mut list_index2 = runtime.get_data_mut().start_list(3).unwrap();
        list_index2 = runtime.get_data_mut().add_to_list(list_index2, i13).unwrap();
        list_index2 = runtime.get_data_mut().add_to_list(list_index2, i16).unwrap();
        list_index2 = runtime.get_data_mut().add_to_list(list_index2, i19).unwrap();
        let list_index2 = runtime.get_data_mut().end_list(list_index2).unwrap();
    ...
    fn equality_mixed_values_equal() {
        ...
        let mut list_index1 = runtime.get_data_mut().start_list(3).unwrap();
        list_index1 = runtime.get_data_mut().add_to_list(list_index1, i3).unwrap();
        list_index1 = runtime.get_data_mut().add_to_list(list_index1, i4).unwrap();
        list_index1 = runtime.get_data_mut().add_to_list(list_index1, i7).unwrap();
        let list_index1 = runtime.get_data_mut().end_list(list_index1).unwrap();
        ...
        let mut list_index2 = runtime.get_data_mut().start_list(3).unwrap();
        list_index2 = runtime.get_data_mut().add_to_list(list_index2, i11).unwrap();
        list_index2 = runtime.get_data_mut().add_to_list(list_index2, i12).unwrap();
        list_index2 = runtime.get_data_mut().add_to_list(list_index2, i15).unwrap();
        let list_index2 = runtime.get_data_mut().end_list(list_index2).unwrap();
