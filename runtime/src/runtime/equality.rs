...
#[cfg(test)]
mod concatenation {
    use crate::testing_utilites::{add_concatenation_with_start, add_list_with_start, create_simple_runtime};
    use crate::{runtime::GarnishRuntime, ExpressionDataType, GarnishLangRuntimeData};
...
mod slices {
    ...
    fn slice_of_link_slice_of_link() {
        ...
        let d1 = add_links_with_start(runtime.get_data_mut(), 10, true, 15);
        let d2 = add_range(runtime.get_data_mut(), 0, 4);
        let d3 = runtime.get_data_mut().add_slice(d1, d2).unwrap();

        let d4 = add_links_with_start(runtime.get_data_mut(), 10, true, 10);
        let d5 = add_range(runtime.get_data_mut(), 5, 9);
        let d6 = runtime.get_data_mut().add_slice(d4, d5).unwrap();
    ...
    fn slice_of_link_slice_of_list_not_equal() {
        ...
        let d4 = add_list_with_start(runtime.get_data_mut(), 10, 11);
        let d5 = add_range(runtime.get_data_mut(), 5, 9);
        let d6 = runtime.get_data_mut().add_slice(d4, d5).unwrap();
    ...
    fn slice_of_list_slice_of_link_not_equal() {
        ...
        let d4 = add_links_with_start(runtime.get_data_mut(), 10, true, 11);
        let d5 = add_range(runtime.get_data_mut(), 5, 9);
        let d6 = runtime.get_data_mut().add_slice(d4, d5).unwrap();
    ...
    fn slice_of_link_slice_of_incomplete_link_equal() {
        ...
        let link2 = runtime.get_data_mut().add_link(unit, link1, true).unwrap();
        let link3 = runtime.get_data_mut().add_link(unit, link2, true).unwrap();

        let link4 = runtime.get_data_mut().add_link(d1, unit, true).unwrap();

        let range1 = add_range(runtime.get_data_mut(), 0, 2);
        let slice1 = runtime.get_data_mut().add_slice(link3, range1).unwrap();
        let slice2 = runtime.get_data_mut().add_slice(link4, range1).unwrap();
    ...
    fn slice_of_link_slice_of_incomplete_link_not_equal() {
        ...
        let link1 = runtime.get_data_mut().add_link(d1, unit, true).unwrap();
        let link2 = runtime.get_data_mut().add_link(d2, link1, true).unwrap();
        let link3 = runtime.get_data_mut().add_link(unit, link2, true).unwrap();
...
#[cfg(test)]
mod links {
    use crate::testing_utilites::{add_links_with_start, add_list_with_start, create_simple_runtime};
    use crate::{runtime::GarnishRuntime, ExpressionDataType, GarnishLangRuntimeData};
    ...
    fn append_link_append_link_equal() {
        ...
        let list1 = add_links_with_start(runtime.get_data_mut(), 10, true, 20);
        let list2 = add_links_with_start(runtime.get_data_mut(), 10, true, 20);

        runtime.get_data_mut().push_register(list1).unwrap();
        runtime.get_data_mut().push_register(list2).unwrap();
    ...
    fn append_link_append_link_not_equal() {
        ...
        let list1 = add_links_with_start(runtime.get_data_mut(), 10, true, 20);
        let list2 = add_links_with_start(runtime.get_data_mut(), 10, true, 15);
    ...
    fn append_link_prepend_link_equal() {
        ...
        let list1 = add_links_with_start(runtime.get_data_mut(), 10, true, 20);
        let list2 = add_links_with_start(runtime.get_data_mut(), 10, false, 20);
    ...
    fn append_link_prepend_link_not_equal() {
        ...
        let list1 = add_links_with_start(runtime.get_data_mut(), 10, true, 20);
        let list2 = add_links_with_start(runtime.get_data_mut(), 10, false, 15);
    ...
    fn prepend_link_append_link_equal() {
        ...
        let list1 = add_links_with_start(runtime.get_data_mut(), 10, false, 20);
        let list2 = add_links_with_start(runtime.get_data_mut(), 10, true, 20);
    ...
    fn link_list_equal() {
        ...
        let list1 = add_links_with_start(runtime.get_data_mut(), 10, true, 20);
        let list2 = add_list_with_start(runtime.get_data_mut(), 10, 20);
    ...
    fn link_list_not_equal() {
        ...
        let list1 = add_links_with_start(runtime.get_data_mut(), 10, true, 20);
        let list2 = add_list_with_start(runtime.get_data_mut(), 10, 15);
